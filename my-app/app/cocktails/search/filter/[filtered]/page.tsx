...
import { fetchCocktailsExcludingIngredient } from '../../../cocktails.api';
...
async function RecipesList({params: {filtered}}: RecipeProps) {
  const cocktails = await fetchCocktailsExcludingIngredient(filtered);
